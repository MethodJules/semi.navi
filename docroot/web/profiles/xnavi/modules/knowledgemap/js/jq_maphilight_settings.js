...
(function ($) {
    Drupal.behaviors.jq_maphilight = {
        attach: function (context, settings) {
            var options = {
                ...
                stringAreaHide: settings.jq_maphilight.stringAreaHide,
                stringAreaShow: settings.jq_maphilight.stringAreaShow
            };
    ...
    Drupal.behaviors.jq_maphilight.attachHover = function(selector) {
        if (drupalSettings.jq_maphilight.mouseover == 'true') {
            selector.on("mouseover.maphilight", function () {
                var optionsMouseover = {};
                optionsMouseover.stroke = true;
                optionsMouseover.fill = true;
                optionsMouseover.fillOpacity = drupalSettings.jq_maphilight.fillOpacityMouseover;
                optionsMouseover.strokeOpacity = drupalSettings.jq_maphilight.strokeOpacityMouseover;
            ...
            selector.on("mouseleave.maphilight", function () {
                ...
                optionsMouseLeave.stroke = drupalSettings.jq_maphilight.stroke;
                optionsMouseLeave.fill = drupalSettings.jq_maphilight.fill;
                optionsMouseLeave.fillOpacity = drupalSettings.jq_maphilight.fillOpacity;
                optionsMouseLeave.strokeOpacity = drupalSettings.jq_maphilight.strokeOpacity;
